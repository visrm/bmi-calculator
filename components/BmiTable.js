    ...
    <>
      <div className="grid text-black min-h-[480px] min-w-[360px] w-11/12 sm:w-1/2 text-sm">
        <div className="rows grid grid-cols-3 place-items-center p-4 border-2 bg-secondary">
          ...
          <div className="font-bold">
            Weight<span className="font-light text-xs"> ( in kg ) </span>{" "}
          </div>
        </div>
        <div className={bmi < 16.0 ? "border-4 scale-105 border-secondary" : "border-0"}>
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
        ...
        <div
          className={
            bmi > 16.0 && bmi < 16.9 ? "border-4 scale-105 border-secondary" : "border-0"
          }
        >
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
        ...
        <div
          className={
            bmi > 17.0 && bmi < 18.4 ? "border-4 scale-105 border-secondary" : "border-0"
          }
        >
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
        ...
        <div
          className={
            bmi > 18.5 && bmi < 24.9 ? "border-4 scale-105 border-secondary" : "border-0"
          }
        >
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
        ...
        <div
          className={
            bmi > 25.0 && bmi < 29.9 ? "border-4 scale-105 border-secondary" : "border-0"
          }
        >
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
            <div>Overweight</div>
        ...
        <div
          className={
            bmi > 30.0 && bmi < 34.9 ? "border-4 scale-105 border-secondary" : "border-0"
          }
        >
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
        ...
        <div
          className={
            bmi > 35.0 && bmi < 40.0 ? "border-4 scale-105 border-secondary" : "border-0"
          }
        >
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
        ...
        <div className={bmi > 40.0 ? "border-4 scale-105 border-secondary" : "border-0"}>
          <div className="rows grid grid-cols-3 place-items-center p-4 border-2">
