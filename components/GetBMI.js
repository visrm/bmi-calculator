export default function GetBMI({ bmi, bmiType, weighChange }) {
  return (
    <>
      <div className="flex justify-center items-center mx-auto my-4 flex-col flex-nowrap p-2 md:p-4 border shadow-lg sm:shadow-xl bg-accent text-white font-poppins rounded-lg h-1/3 sm:h-2/5 w-2/3 sm:w-2/5 z-20">
